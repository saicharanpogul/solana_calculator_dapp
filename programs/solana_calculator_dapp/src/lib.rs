...
pub mod solana_calculator_dapp {
    ...
    pub fn calculate(ctx:Context<Calculate>, message:String, num1:i64, num2:i64) -> ProgramResult {
      let calculator = &mut ctx.accounts.calculator;
      if message == "ADD" {
        calculator.result = num1 + num2;
        println!("{} + {} = {}", num1, num2, calculator.result);
        Ok(())
      } else if message == "SUB" {
        calculator.result = num1 - num2;
        println!("{} - {} = {}", num1, num2, calculator.result);
        ...
        println!("{} / {} = {} with remainder {}", num1, num2, calculator.result, calculator.remainder);
        Ok(())
      } else {
